#!/usr/bin/env python3
"""ParityMNIST: bf16 vs fp32 master weights, 5 seeds, CPU only."""
...
OUTPUT = Path("experiments/bf16_vs_fp32_master_multiseed")
...
if __name__ == "__main__":
    ...
    for method in methods:
        for mbits, wl in [(7,"bf16"),(23,"fp32")]:
            key = f"{method}_{wl}"
            pars, fashs, kls = [], [], []
            for seed in SEEDS:
            ...
            print(f"{key:<16} par={pm:.4f}±{ps:.4f}  fash={fm:.4f}±{fs:.4f}  KL={km:.4f}±{ks:.4f}")
